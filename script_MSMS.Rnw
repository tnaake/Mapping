...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["6"]], c("mz", "rt", "id")]
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["9"]], c("mz", "rt", "id")] ## take 308.._99.._6! 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["11"]], c("mz", "rt", "id")]
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["21"]], c("mz", "rt", "id")] ## take 715..2176..3373
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["36"]], c("mz", "rt", "id")]
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["57"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["73"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["74"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["79"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["85"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["87"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["115"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["117"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["124"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["140"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["142"]], c("mz", "rt", "id")] ## remove 112.._68_110 (singleton and seems to be part of 280.._67_26)
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["144"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["149"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["196"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["218"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["239"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["257"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["285"]], c("mz", "rt", "id")] ## share only one fragment (247.08) high drt
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["325"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["329"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["337"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["367"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["647"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["725"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["753"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["821"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["839"]], c("mz", "rt", "id")] ## 149.._73.._16 seems to be part of 203.._71.._15, remove 149.._73.._16
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["868"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["869"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1287"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1630"]], c("mz", "rt", "id")] 
...
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1676"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1683"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1752"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1973"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1981"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["1997"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2005"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2041"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2689"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2707"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2719"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2834"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["2912"]], c("mz", "rt", "id")]
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3012"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3039"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3047"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3078"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3080"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3108"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3112"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3114"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3204"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3224"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3226"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3270"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3342"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3397"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["3946"]], c("mz", "rt", "id")] 
MSMS_mod[MSMS_mod[, "id"] %in% mapping_l[["4059"]], c("mz", "rt", "id")] 
...
dev.off(); grid.draw(venn.diagram(list("N. att" = att0, "N. obt" = obt0, "N.clev" = clev0, "N. quad" = quad0), filename = NULL) )
...
dev.off(); grid.draw(venn.diagram(list("N. att" = att72WOS, "N. obt" = obt72WOS, "N.clev" = clev72WOS, "N. quad" = quad72WOS), filename = NULL) )
...
dev.off(); grid.draw(venn.diagram(list("N. att" = att72MJ, "N. obt" = obt72MJ, "N.clev" = clev72MJ, "N. quad" = quad72MJ), filename = NULL) )
...
AttObtX1027Overlap0h <- calculate.overlap(list("N. attenuata" = att0, 
                                               ...
                                               "N. x 1027" = x10270, 
                                               "N. x 57126" = x571260))
dev.off(); grid.draw(venn.diagram(list("N. att" = att0, "N. obt" = obt0, "N.x1027" = x10270, "N. x57126" = x571260), filename = NULL) )
...
dev.off(); grid.draw(venn.diagram(list("N. att" = att72WOS, "N. obt" = obt72WOS, "N.x1027" = x102772WOS, "N. x57126" = x5712672WOS), filename = NULL) )
...
dev.off(); grid.draw(venn.diagram(list("N. att" = att72MJ, "N. obt" = obt72MJ, "N.x1027" = x102772MJ, "N. x57126" = x5712672MJ), filename = NULL) )
...
# # ## N. attenuata 0h and 72 WOS
# colsAtt0 <- c("X92_20ev", "X92_30ev", "X92_40ev", "X92_MS")
# peaktableBINARY[, colsAtt0] <- peaktableBINARYspecies(peaktable, colsAtt0, background)
# colsAtt72WOS <- c("X14_20ev", "X14_30ev", "X14_40ev", "X14_MS")
# peaktableBINARY[, colsAtt72WOS] <- peaktableBINARYspecies(peaktable, colsAtt72WOS, background)
# 
# ## N. obtusifolia 0h and 72h WOS
# colsObt0 <- c("X106_20ev", "X106_30ev", "X106_40ev", "X106_MS")
# peaktableBINARY[, colsObt0] <- peaktableBINARYspecies(peaktable, colsObt0, background)
# colsObt72WOS <- c("X27_20ev", "X27_30ev", "X27_40ev", "X27_MS")
# peaktableBINARY[, colsObt72WOS] <- peaktableBINARYspecies(peaktable, colsObt72WOS, background)
# 
# ## N. clevelandii 0h and 72h WOS
# colsClev0 <- c("X124_20ev", "X124_30ev", "X124_40ev", "X124_MS")
# peaktableBINARY[, colsClev0] <- peaktableBINARYspecies(peaktable, colsClev0, background)
# colsClev72WOS <- c("X42_20ev", "X42_30ev", "X42_40ev", "X42_MS")
# peaktableBINARY[, colsClev72WOS] <- peaktableBINARYspecies(peaktable, colsClev72WOS, background)
# 
# ## N. quadrivalvis 0h and 72h WOS
# colsQuad0 <- c("X138_20ev", "X138_30ev", "X138_40ev", "X138_MS")
# peaktableBINARY[, colsQuad0] <- peaktableBINARYspecies(peaktable, colsQuad0, background)
# colsQuad72WOS <- c("X57_20ev", "X57_30ev", "X57_40ev", "X57_MS")
# peaktableBINARY[, colsQuad72WOS] <- peaktableBINARYspecies(peaktable, colsQuad72WOS, background)
# 
# ## N. x10/27 0h and 72h WOS
# colsX10270 <- c("X154_20ev", "X154_30ev", "X154_40ev", "X154_MS")
# peaktableBINARY[, colsX10270] <- peaktableBINARYspecies(peaktable, colsX10270, background)
# colsX102772WOS <- c("X73_20ev", "X73_30ev", "X73_40ev", "X73_MS")
# peaktableBINARY[, colsX102772WOS] <- peaktableBINARYspecies(peaktable, colsX102772WOS, background)
# 
# ## N. x57/126 0h and 72h WOS
# colsX571260 <- c("X170_20ev", "X170_30ev", "X170_40ev", "X170_MS")
# peaktableBINARY[, colsX571260] <- peaktableBINARYspecies(peaktable, colsX571260, background)
# colsX5712672WOS <- c("X86_20ev", "X86_30ev", "X86_40ev", "X86_MS")
# peaktableBINARY[, colsX5712672WOS] <- peaktableBINARYspecies(peaktable, colsX5712672WOS, background)
# 
# # ## now truncate object MSMS, so that it only contains features which show up in species
# # ## truncate first peaktable so that it only contains lines with present features
# peaktableBINARYSpecies_cut <- function(pt, colname) {
#     ptBin <- pt[pt[, colname] == 1, c("mz", "rt", colname, "isotopes", "adduct", "pcgroup", "npeaks")]
#     return(ptBin)
# }
# ptBINARYAtt <- peaktableBINARYSpecies_cut(peaktableBINARY, "X14_MS")
# ptBINARYObt <- peaktableBINARYSpecies_cut(peaktableBINARY, "X27_MS")
# ptBINARYClev <- peaktableBINARYSpecies_cut(peaktableBINARY, "X42_MS")
# ptBINARYQuad <- peaktableBINARYSpecies_cut(peaktableBINARY, "X57_MS")
# ptBINARYX1027 <- peaktableBINARYSpecies_cut(peaktableBINARY, "X73_MS")
# ptBINARYX57126 <- peaktableBINARYSpecies_cut(peaktableBINARY,"X86_MS")
# 
# ## write for each species to binary table mm72WOS
# mm72WOS <- matrix(nrow = length(uniquePrecursor), ncol = 6)
# rownames(mm72WOS) <- uniquePrecursor
# # 
# # ## create function
# writeToBinaryMatrix <- function(ptBINARYSpecies, MSMS) {
#     mzVsRTbalance <- 1000
#     MSMS_species <- cbind(MSMS, numeric(length(dim(MSMS)[1])))
#     colnames(MSMS_species)[5] <- "presence"
#     precursor <- as.character(MSMS_species[, "pcgroup_precursorMZ"])
#     uniquePrecursor <- unique(precursor)
#     for (i in 1:length(ptBINARYSpecies[,"mz"])) {
#         objective <- mzVsRTbalance * (abs(ptBINARYSpecies[i,"mz"] - MSMS_species[,"mz"])) + abs(ptBINARYSpecies[i, "rt"] - MSMS[, "rt"])
#         objective_threshold <- objective < 0.5
#         MSMS_species[objective_threshold, 5] <- 1
#     }
#     ## filter
#     ## set presence for all features to 1 when more than 90% have presence == 1
#     for (i in 1:length(uniquePrecursor)) {
#         inds <- which(uniquePrecursor[i] == precursor)
#         if ( (sum(MSMS_species[inds, "presence"]) / length(inds)) > 0.9) {
#             MSMS_species[inds, "presence"] <- 1
#         } else {MSMS_species[inds, "presence"] <- 0}
#     }
# 
#     binary <- numeric(length(uniquePrecursor))
# 
#     ## write to binary table
#     for (i in 1:length(uniquePrecursor)) {
#         inds <- which(uniquePrecursor[i] == precursor)[1]
#         if (MSMS_species[inds, "presence"] == 0) {binary[i] <- 0} else {binary[i] <- 1}
#     }
# 
#     return(binary)
# }
# # 
# ## N. attenuata
# mm72WOS[, 1] <- writeToBinaryMatrix(ptBINARYAtt, MSMS)
# ## N. obtusifolia
# mm72WOS[, 2] <- writeToBinaryMatrix(ptBINARYObt, MSMS)
# ## N. clevelandii
# mm72WOS[, 3] <- writeToBinaryMatrix(ptBINARYClev, MSMS)
# ## N. quadrivalvis
# mm72WOS[, 4] <- writeToBinaryMatrix(ptBINARYQuad, MSMS)
# ## N. x obtusiata 10/27
# mm72WOS[, 5] <- writeToBinaryMatrix(ptBINARYX1027, MSMS)
# ## N. x obtusiata 57/126
# mm72WOS[, 6] <- writeToBinaryMatrix(ptBINARYX57126, MSMS)
...
hClustMSPd <- hcluster(similarityMat, method = "euclidean", link = "average")
